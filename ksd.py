...
FOLDER_PATH_1 = r'\\192.168.25.97\c$\Logs\Data\Currents\STATISTIKS_1_4_pogruzka_' # r'Currents'
FOLDER_PATH_2 = r'\\192.168.25.97\c$\Logs\Data\Currents\STATISTIKS_5_8_pogruzka_' # r'Currents'

FILENAME_1 = 'Half_vagon1_40.csv'
FILENAME_2 = 'Half_vagon5_80.csv'

TEMPLATE_PATH = 'шаблон_ксд.docx'
...
def main():
    filepath_1 = os.path.join(FOLDER_PATH_1, FILENAME_1)
    filepath_2 = os.path.join(FOLDER_PATH_2, FILENAME_2)
    parsed_logs = []
    parsed_logs.extend(get_parsed_log(filepath_1))
    parsed_logs.extend(get_parsed_log(filepath_2))
    full_report = get_full_report(parsed_logs)
    print(get_events_table(full_report))
    try:
        create_doc_final(TEMPLATE_PATH, full_report, 'ksd_report')
    except PermissionError:
        create_doc_final(TEMPLATE_PATH, full_report, 'ksd_report', exists=True)
    with open('ksd_report.json', 'w', encoding='utf8') as file:
